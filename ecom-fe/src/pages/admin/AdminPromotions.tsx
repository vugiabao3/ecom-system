        ...
        <div>
            ...
            <div className="admin-container">
                <div className="admin-header">
                    <div>
                        <h1 style={{ fontSize: "24px", color: "#222" }}>🏷️ Discount & Coupon Management</h1>
                        <p style={{ color: "#666" }}>Create promotion codes, set discount rates and stock usage limits.</p>
                    </div>
                    <button
                ...
                <div className="admin-nav">
                    ...
                    <Link to="/admin/promotions" className="admin-nav-item active">Promotions</Link>
                    <Link to="/admin/shipping" className="admin-nav-item">Shipping & Orders</Link>
                </div>

                <div className="admin-card">
                    <h3>All Promotions ({promotions.length})</h3>
                    {loading ? (
                            ...
                            <tbody>
                                {promotions.map((p) => (
                                    <tr key={p.id}>
                                        ...
                                        <td>
                                            <button className="admin-btn info" onClick={() => openEdit(p)}>
                                                Edit
                                            </button>
                    ...
                    <div className="modal-overlay" onClick={() => setEditingPromotion(null)}>
                        <div className="modal-content" onClick={(e) => e.stopPropagation()} style={{ width: "450px" }}>
                            ...
                            <form onSubmit={handleUpdate}>
                                ...
                                <div style={{ display: "flex", gap: "10px", justifyContent: "flex-end" }}>
                                    <button type="button" className="admin-btn secondary" onClick={() => setEditingPromotion(null)}>Cancel</button>
